...
namespace Nucleus.Tests
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(" v) Genetic Algorithm");
            Console.WriteLine(" w) Simulated Annealing");

            ConsoleKeyInfo cKI = Console.ReadKey(true);

            while (cKI.Key != ConsoleKey.Escape)
            {
                char option = cKI.KeyChar;
                ...
                {
                    Optimisation_Tests.GeneticAlgorithmTest();
                }

                if (option == 'a' || option == 'w')
                {
                    Optimisation_Tests.SimulatedAnnealingTest();
                }
